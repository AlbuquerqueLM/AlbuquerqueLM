  <!-- Opa, olá, tudo bom? Veio ver o meu código? A casa é sua. -->
...
<p align="center">
  Desenvolvedor apaixonado por Python, Java e automação.</p>
  <p align="center">
  Aqui no Github eu compartilho projetos de programação, bots, jogos e muito mais.  <img src="https://media.tenor.com/TjwMUc2obFwAAAAj/portal-fire.gif" alt="gameboy" width="30"
</p>
...
```
<!-- O código inteiro no java ficaria algo gigantesco, mas até essa parte eu achei que ficou bonito e condiz para a minha apresentação nessa pagina, já que eu não preciso compilar em um markdown, tudo bem ter cortado o final do código, você não acha? -->
...
<!-- Com a faculdade de Engenharia de Software, tenho um desejo muito crescente em aumentar o meu portfólio e principalmente, aperfeiçoar os conhecimentos que eu já reuni nesses anos.-->
